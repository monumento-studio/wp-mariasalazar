  ...
  <div class="container">
    <div class="detox sec">
      <div class="row">
        <div class="col col--3-of-16 col--push-3-of-16">
          <div class="lead"><a href="detox.html">
              <h2><?php echo $titulo_programa_1; ?></h2></a></div>
        </div>
        <div class="col col--4-of-16">
          <p><?php echo $descripcion_programa_1; ?></p>
        </div>
        <div class="col col--3-of-16 col--ab col--pull-7-of-16 arrow"><img src="<?php bloginfo('stylesheet_directory'); ?>/assets/img/arrow1.svg"><a href="detox.html">
    ...
    <div class="anti sec">
      <div class="row">
        ...
        <div class="col col--3-of-16 col--push-3-of-16">
          <div class="lead"><a href="anti-estrés.html">
              <h2><?php echo $titulo_programa_2; ?></h2></a></div>
        </div>
        <div class="col col--4-of-16">
          <p><?php echo $descripcion_programa_2; ?></p>
        </div>
        <div class="col col--3-of-16 col--ab col--pull-7-of-16 arrow"><img src="<?php bloginfo('stylesheet_directory'); ?>/assets/img/arrow1.svg"><a href="anti-estrés.html">
